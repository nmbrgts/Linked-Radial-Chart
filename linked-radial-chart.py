...
div2 = Div(text='''
    ...
    <p> 
      ...
      Elija Meek's 
      <a href='https://bl.ocks.org/susielu/b6bdb82045c2aa8225f5'>
    ...
    <p>
      This visualization reverses the relationship between the charts. 
      ...
      of the cartesian chart updates the 'selection' window of the radial chart 
